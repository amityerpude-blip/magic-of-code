...
function initializeTransmission(option){
    ...
    sender.innerHTML = `
        ...
        <div class="nodeLabel">Sender</div>
    `;
    ...
    receiver.innerHTML = `
        <div class="nodeIcon">🖥️</div>
        <div class="nodeLabel">Receiver</div>
    `;
    ...
    path.innerHTML = `
        <div class="networkLine"></div>
        <div class="networkLabel">📡 NETWORK</div>
    `;
    ...
    const line = path.querySelector(".networkLine");
    ...
    if(line){
        Object.assign(line.style,{
            ...
            borderRadius:"10px",
            boxShadow:"0 0 15px rgba(56,189,248,.7)"
        });
    }

    const label = path.querySelector(".networkLabel");
