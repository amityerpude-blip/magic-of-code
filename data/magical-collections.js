...
comic:{title:"📖 Dino and the Four Collection Keepers",description:"Dino discovers four magical vaults: the String Scroll, List Basket, Tuple Chest and Dictionary Hall.",folder:"../assets/comic/",totalPages:1},
...
{question:"Which collection is mutable?",options:["String","Tuple","List","None"],answer:2},
{question:"Which collection stores key-value pairs?",options:["List","Tuple","Dictionary","String"],answer:2},
{question:"Which collection is immutable?",options:["List","Dictionary","Tuple","All lists"],answer:2},
{question:"What is the first index of a Python sequence?",options:["0","1","-1","10"],answer:0},
{question:"Which method adds one item to a list?",options:["add()","append()","push()","insertEnd()"],answer:1},
{question:"What does len('Dino') return?",options:["3","4","5","0"],answer:1},
{question:"How is a dictionary value accessed?",options:["By key","Only by position","Only by index","By line number"],answer:0},
{question:"Which brackets are normally used for a list?",options:["()","{}","[]","<>"],answer:2},
{question:"Which brackets are normally used for a tuple?",options:["()","[]","{}","//"],answer:0},
{question:"Which operation extracts part of a string or list?",options:["Slicing","Casting","Looping","Compiling"],answer:0}
]},
challenge:{title:"🏆 Guardian Battle",description:"Complete the final collection mission.",icon:"🧩",heading:"The Four Vault Challenge",story:"The Guardian has locked four treasure vaults. Dino must use the correct Python collection for each task.",tasks:["🔤 Store and format a student's name using a string.","🧺 Store five marks in a list and calculate the highest mark.","📦 Store a fixed pair of coordinates in a tuple.","📖 Store a student's name and marks in a dictionary.","🧩 Create one nested collection and display a value from it."]},
footer:{button:"Continue to Stack Tower"}
};
